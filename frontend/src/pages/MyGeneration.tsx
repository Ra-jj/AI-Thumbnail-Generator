                ...
                >
                  ...
                  >
                    <TrashIcon
                      ...
                      className="size-6 bg-black/50 p-1 rounded hover:bg-emerald-600 transition-all"
                    />
                    <DownloadIcon
                    ...
                    >
                      <ArrowRightIcon className="size-6 bg-black/50 p-1 rounded hover:bg-emerald-600 transition-all" />
                    </Link>
                  </div>
                </div>
              );
