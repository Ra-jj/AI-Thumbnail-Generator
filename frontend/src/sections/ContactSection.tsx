    ...
    <div id="contact" className="px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      >
        ...
        >
          ...
          <div className="flex items-center pl-3 rounded-lg border border-slate-700 focus-within:border-emerald-500">
        ...
        >
          ...
          <textarea
            ...
            className="focus:border-emerald-500 resize-none w-full p-3 outline-none rounded-lg border border-slate-700"
          />
        </motion.div>

        <motion.button
          type="submit"
          className="w-max flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-3 rounded-full"
          initial={{ y: 150, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
