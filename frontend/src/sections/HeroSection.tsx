...
export default function HeroSection() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
      <div className="absolute top-30 -z-10 left-1/4 size-72 bg-emerald-600 blur-[300px]"></div>
      <motion.a
        href="https://prebuiltui.com?utm_source=pixels"
        className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-emerald-100 bg-emerald-200/15"
      ...
      >
        <span className="bg-emerald-800 text-white text-xs px-3.5 py-1 rounded-full">
          NEW
        </span>
      ...
      >
        <button
          ...
          className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-full px-7 h-11"
        >
          Generate now
        </button>
        <button className="flex items-center gap-2 border border-emerald-900 hover:bg-emerald-950/50 transition rounded-full px-6 h-11">
