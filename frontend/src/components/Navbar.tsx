    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 transition duration-500">
          <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="hover:text-emerald-300 transition">
            Home
          </Link>
          <Link to="/generate" className="hover:text-emerald-300 transition">
            Generate
          </Link>
          {isLoggedIn ? (
            <Link
        ...
        <div className="flex items-center gap-2">
          {isLoggedIn ? (
            ...
            <button
              ...
              className="hidden md:block px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 active:scale-95 transition-all rounded-full"
            >
              Get Started
            </button>
          )}
      ...
      >
        <Link onClick={() => { setIsOpen(false); window.scrollTo({ top: 0, behavior: "smooth" }); }} to="/">
          Home
        </Link>
        ...
        <button
          ...
          className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-emerald-600 hover:bg-emerald-700 transition text-white rounded-md flex"
        >
          <XIcon />
        </button>
      </div>
